...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
    <head>
        ...
        <title><?php echo e(config('app.name', 'ValoHome 3D - Design & Value')); ?></title>

        <!-- Favicon / Logo do Navegador com cache buster -->
        <link rel="icon" type="image/png" sizes="64x64" href="<?php echo e(asset('imagem/favicon_small.png')); ?>?v=3">
        <link rel="icon" type="image/png" href="<?php echo e(asset('favicon.png')); ?>?v=3">
        <link rel="shortcut icon" href="<?php echo e(asset('favicon.png')); ?>?v=3">
        <link rel="apple-touch-icon" href="<?php echo e(asset('imagem/favicon_small.png')); ?>?v=3">
    ...
    <body class="antialiased selection:bg-[#C4B5A5]/30 selection:text-[#2B2927]">
                ...
                <div class="flex justify-between h-20 items-center">
                    <div class="flex-shrink-0 flex items-center">
                        <a href="/" class="flex items-center gap-3">
                            <img src="<?php echo e(asset('imagem/valohome_logo.png')); ?>?v=3" alt="ValoHome 3D Logo" class="h-12 w-auto object-contain mix-blend-multiply">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <footer class="py-10 text-center border-t border-[#C4B5A5]/40 bg-[#FAF8F5]">
            ...
            <p class="text-xs text-[#4A4643]">
                &copy; <?php echo e(date('Y')); ?> ValoHome 3D. Todos os direitos reservados.
            </p>
        </footer>
    </body>
</html>
<?php /**PATH C:\Users\Evolusat\Documents\GitHub\Shift3D\resources\views/layouts/public.blade.php ENDPATH**/ ?>